...
async def start_sms_spam(phone, cycles):
    for i in range(0, cycles):
        ...
        phone9 = phone[1:]
    try:
        formatted_phone = format_phone(phone, pattern_1)
    ...
    try:
        formatted_phone = format_phone(phone[1:], pattern_2)
    ...
    try:
        ...
        logger.error("Request failed")
    try:
        formatted_phone = format_phone(phone, pattern_3)
    ...
    try:
        ...
        logger.error("Request failed")
    try:
        formatted_phone = format_phone(phone, pattern_2)
    ...
    try:
        ...
        logger.error("Request failed")
    try:
        formatted_phone = format_phone(phone9, pattern_2)
        ...
        logger.error("Request failed")
    try:
        formatted_phone = format_phone(phone9, pattern_4)
